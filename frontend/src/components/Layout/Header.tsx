...
import { Truck, User, Menu, X } from 'lucide-react';
        ...
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-primary">CargoConnect</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link to="/profile" className="flex items-center space-x-2 rounded-full bg-background p-2 transition-colors hover:bg-border">
