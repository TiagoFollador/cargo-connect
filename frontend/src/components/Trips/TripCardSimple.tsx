...
import { MapPin, Calendar, DollarSign, TruckIcon, Package, Eye } from "lucide-react";
...
const TripCardSimple: React.FC<TripCardSimpleProps> = ({ trip, onAccept, onViewDetails }) => {
  ...
  const formattedDate = pickupDate ? new Date(pickupDate).toLocaleDateString("pt-BR", {
    year: "numeric",
    month: "short",
    day: "numeric",
  }) : "Data não informada";
    ...
    <div className="card group hover:shadow-md overflow-hidden slide-up">
      ...
      <div className="mb-6 space-y-3">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div>
            <p className="text-sm font-medium">{trip.description || 'Carga geral'}</p>
